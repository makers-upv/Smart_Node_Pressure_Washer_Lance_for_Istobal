/*
  ...
  Programa que ejecuta la seccion Base de un enlace RF con los modulos NRF24L01
  Recibe un texto desde el extremo Remoto y muestra en monitor serie, luego envia
  un texto de respuesta.
  Requiere instalar libreria RadioHead
...
void loop()
{
  ...
  {  
    ...
    if (nrf24.recv(buf, &len))      // si hay informacion valida en el buffer
    {
      ...
      uint8_t data[] = "Hola Lanzadera"; // se almacena texto a enviar
